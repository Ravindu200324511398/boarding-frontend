...
const Navbar = () => {
  ...
  // Inquiries dropdown handlers with delay
  const handleInquiriesEnter = () => {
    if (inquiriesTimer.current) clearTimeout(inquiriesTimer.current);
    setShowInquiries(true);
  };
  const handleInquiriesLeave = () => {
    inquiriesTimer.current = setTimeout(() => setShowInquiries(false), 150);
  };

  // User menu dropdown handlers with delay
          ...
          <div className="desktop-nav-center" style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
            ...
            {isAuth && (
              ...
              >
                ...
                {showInquiries && (
                  /* Outer wrapper: transparent padding creates hover bridge so mouse can travel to dropdown */
                  <div
          ...
          <div className="desktop-nav-right-items" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            {isAuth ? (
              ...
              >
                ...
                {showUserMenu && (
                  /* Outer wrapper: transparent padding creates hover bridge */
                  <div
